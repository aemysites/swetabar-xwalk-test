...
## Environments
- Preview: https://main--swetabar-xwalk-test--aemysites.aem.page/
- Live: https://main--swetabar-xwalk-test--aemysites.aem.live/
- Block Library: https://main--swetabar-xwalk-test--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `swetabar-xwalk-test` directory in your favorite IDE and start coding :)
